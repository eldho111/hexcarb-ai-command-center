...
export type ViewType = "chat" | "list-detail" | "dashboard" | "form-action" | "workflow" | "crud" | "runner";
...
export const PANELS: PanelDef[] = [
  ...
  },
  {
    ...
    section: "diagnostics",
    viewType: "form-action",
    instructions: "Run CNT lead intelligence to discover potential customers, partners, and research collaborators.",
    viewConfig: {
      submitEndpoint: "/lead_intel/run",
      fields: [],
      submitLabel: "Run Lead Intel",
    } satisfies FormActionConfig,
    relatedPanels: [
      { panelId: "scout", label: "Research Scout" },
